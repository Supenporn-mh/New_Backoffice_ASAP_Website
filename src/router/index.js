...
const routes = [
  {
    ...
    children: [
      ...
      // ASAP พร้อมให้บริการ
      {
        path: 'asap-ready',
        name: 'AsapReadyList',
        component: () => import('@/views/asap-ready/AsapReadyList.vue'),
        meta: { title: 'ASAP พร้อมให้บริการ' }
      },
      {
        path: 'asap-ready/create',
        name: 'AsapReadyCreate',
        component: () => import('@/views/asap-ready/AsapReadyForm.vue'),
        meta: { title: 'เพิ่มรูปภาพ ASAP พร้อมให้บริการ' }
      },
      {
        path: 'asap-ready/:id/edit',
        name: 'AsapReadyEdit',
        component: () => import('@/views/asap-ready/AsapReadyForm.vue'),
        meta: { title: 'แก้ไขรูปภาพ ASAP พร้อมให้บริการ' }
      },
