<template>
  <div class="check-in-detail" v-loading="loading">
    ...
    <div class="detail-content" v-if="checkIn.id">
      ...
      <!-- Confirmed Info -->
      <div class="content-card" v-if="checkIn.status === 'confirmed'">
        <div class="section-title confirmed">
          <el-icon><CircleCheckFilled /></el-icon>
          ข้อมูลการยืนยัน
        </div>
        <p class="action-info">
          ยืนยันโดย: {{ checkIn.actionBy }} | {{ formatDateTime(checkIn.actionDate) }}
        </p>
        <div class="confirmed-notice">
          <el-icon><InfoFilled /></el-icon>
          <span>รายการนี้ได้รับการยืนยันแล้ว รอการอนุมัติขั้นสุดท้ายผ่านระบบ Car Plan</span>
        </div>
      </div>
...
const { getCheckIn, approveCheckIn, rejectCheckIn, confirmCheckIn } = useApi()
