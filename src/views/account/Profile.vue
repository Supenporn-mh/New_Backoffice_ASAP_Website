      ...
      <el-col :span="16">
        ...
        >
          ...
          <div class="form-actions">
            <el-button type="primary" :loading="savingProfile" :disabled="!isDirtyProfile || savingProfile" @click="handleSaveProfile">
              บันทึกข้อมูล
            </el-button>
          </div>
        </el-form>
        ...
        >
          ...
          <div class="form-actions">
            <el-button type="warning" :loading="savingPassword" :disabled="!isDirtyPassword || savingPassword" @click="handleChangePassword">
              เปลี่ยนรหัสผ่าน
            </el-button>
          </div>
        </el-form>
...
const isDirtyProfile = ref(false)
...
watch(() => profileForm, () => { isDirtyProfile.value = true }, { deep: true })
watch(() => passwordForm, () => { isDirtyPassword.value = true }, { deep: true })
