    ...
    >
      ...
      <div class="form-section">
        ...
        <el-row :gutter="24">
          <!-- Desktop Image -->
          <el-col :span="12">
            <el-form-item label="Desktop" prop="image">
              <div class="image-upload-wrapper">
                ...
                >
                  ...
                  <div v-else class="upload-placeholder">
                    <el-icon><Plus /></el-icon>
                    <span>อัปโหลดรูปภาพ Desktop</span>
                  </div>
                </el-upload>
          ...
          <!-- Mobile Image -->
          <el-col :span="12">
            <el-form-item label="Mobile" prop="imageMobile">
              <div class="image-upload-wrapper">
                <el-upload
                  class="image-uploader"
                  :show-file-list="false"
                ...
                >
                  ...
                  <div v-else class="upload-placeholder upload-placeholder--mobile">
                    <el-icon><Plus /></el-icon>
                    <span>อัปโหลดรูปภาพ Mobile</span>
                  </div>
                </el-upload>
                <div class="image-hint">แนะนำขนาด: 390 x 320 px</div>
                <el-input
                  v-model="form.imageAltMobile"
                  placeholder="Alt Text Mobile (สำหรับ SEO)"
                  class="mt-2"
                />
              </div>
            </el-form-item>
